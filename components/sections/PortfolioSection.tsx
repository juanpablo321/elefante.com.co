...
const cases = [
  ...
  },
  {
    ...
    metric: "+65%",
    description: "Crecimiento en engagement y seguidores para una startup de tecnología en Latinoamérica.",
  ...
  },
  {
    ...
    metric: "+48%",
    description: "Aumento en búsquedas de marca y posicionamiento digital para una empresa de alimentos orgánicos.",
  ...
  },
  {
    ...
    category: "SEO & SEM",
    metric: "+120%",
    description: "Tráfico orgánico y posicionamiento en primeras posiciones de Google para un portal de servicios financieros.",
    image: IMAGES.caseEcommerce,
  },
];
