...
const WHATSAPP_NUMBER = "573002432824";
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Hola, me interesa conocer más sobre los servicios de Elefante. ¿Podemos hablar?"
);
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="relative bg-white text-gray-900 rounded-2xl px-4 py-3 shadow-2xl max-w-[220px] text-sm font-medium"
          >
            <button
      ...
      <motion.a
        ...
        className="w-14 h-14 rounded-full flex items-center justify-center shadow-2xl shadow-green-500/30 transition-all duration-300"
